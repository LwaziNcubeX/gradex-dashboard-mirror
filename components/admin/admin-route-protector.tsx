        ...
        <Card className="max-w-md p-8">
          <div className="flex items-center gap-3 rounded-lg bg-destructive/10 p-4">
            ...
            <div>
              ...
              <p className="text-sm text-destructive/80">Please log in to continue</p>
            </div>
          </div>
        </Card>
      </div>
        ...
        <Card className="max-w-md p-8">
          <div className="flex items-center gap-3 rounded-lg bg-destructive/10 p-4">
            ...
            <div>
              ...
              <p className="text-sm text-destructive/80">Only administrators and teachers can access this dashboard.</p>
